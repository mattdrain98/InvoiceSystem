...
- Create Angular project with ng: `ng new invoicesystem.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`invoicesystem.client.esproj`).
